...
class DialogRoleAdd extends StatelessWidget {
      ...
      childern: [
        ...
        ElevatedButton(
          onPressed: () {
            ...
            controller.addRole(tecName.text);
            navigator.pop();
          },
...
class DialogRoleEdit extends StatelessWidget {
  final TextEditingController tecName;
  final RoleEntity role;

  const DialogRoleEdit({
    required this.tecName,
    required this.role,
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    ...
    tecName.text = role.name;

    return DialogUtils.layoutCustomDialog(
      dialogHeaderText: "Edit Role",
      childern: [
        Form(
          key: formKey,
          child: Column(
